...
export enum FAFErrorCode {
  ...
  NETWORK_ERROR = 'FAF_1604',

  // MCP (Model Context Protocol) Errors (1800-1899)
  MCP_ERROR = 'FAF_1801',
  MCP_SERVER_UNAVAILABLE = 'FAF_1802',
  MCP_TOOL_NOT_FOUND = 'FAF_1803',
  MCP_INVALID_RESPONSE = 'FAF_1804',
  MCP_TIMEOUT = 'FAF_1805',
  MCP_PERMISSION_DENIED = 'FAF_1806',
